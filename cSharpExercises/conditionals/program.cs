...
namespace condicionales
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Console.WriteLine("Introduce your weight");
            //double kg;
            //kg = double.Parse(Console.ReadLine());

            //Console.WriteLine("Introduce your height in m");
            //double m;
            ...
            //}
            //else if (numeero1 - 20 == numero2 || numero3 - 20 == numero2)
            //{
...
//        Console.WriteLine(word.Substring ((wordlength/ 2), 1));
    ...
    //        }
            ...
            //{
            //Console.WriteLine("Introduce a number");
            //num = Int32.Parse(Console.ReadLine()); //cant put a variable with the same name (put int again)
            //if (num < 0)
            //{
            ...
            //{
            //    Console.WriteLine("Introduce a number");
            //    int num = Int32.Parse(Console.ReadLine()); //the value is here and it will enter, no need to put a value above
            //} while (num >== 0);

            //Console.WriteLine("Introduce a number");
            //int num = Int32.Parse(Console.ReadLine());
            //int total = 0;               //have to initialize
            // //you cant declare a int twice but you can use it more times
            //for (int i = 0; i < 8; i++)
            //{
            //    Console.WriteLine("Introduce a number");
            ...
            //Console.WriteLine("In what place did you finish the race?");
            //int placement = Int32.Parse(Console.ReadLine());
